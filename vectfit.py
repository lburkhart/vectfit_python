...
if __name__ == '__main__':
    ...
    figure()
    ms=3
    plot(test_s.imag, test_f.real, 'o', ms=ms, label='data real')
    plot(test_s.imag, test_f.imag, 'o', ms=ms, label='data imag')
    plot(test_s.imag, fitted.real, label='fit real')
    plot(test_s.imag, fitted.imag, label='fit imag')
    legend()
    show()
